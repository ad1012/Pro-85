...
import MyHeader from '../../Pro-81-main/components/MyHeader.js'
import firebase from 'firebase';
import db from '../../Pro-81-main/config.js'
  ...
  static navigationOptions = { header: null };
   ...
   renderItem = ( {item, i} ) =>(
     <ListItem
       ...
       subtitle={"item Requested By : " + item.requested_by +"\nStatus : " + item.request_status}
